...
model Type2_tapEv___N_2_M_2
  ...
  PowerGrids.Electrical.Branches.TransformerWithTapChangerMax TRANSFORMER_LOAD_1_1(SNom = 1e9, UNomA = 400e3, UNomB = 63e3, K = 63/400*{0.96, 0.97, 0.98, 0.99, 1.00}, UMax = 60000, UStop = 59000, Ntap = 5, t1st = 1, tNext = 1, tapStart = 5, X = 0.3, R = 0.003, portVariablesPhases = true);
  PowerGrids.Electrical.Branches.TransformerWithTapChangerMax TRANSFORMER_LOAD_1_2(SNom = 1e9, UNomA = 400e3, UNomB = 63e3, K = 63/400*{0.96, 0.97, 0.98, 0.99, 1.00}, UMax = 60000, UStop = 59000, Ntap = 5, t1st = 1, tNext = 1, tapStart = 5, X = 0.3, R = 0.003, portVariablesPhases = true);
  PowerGrids.Electrical.Branches.TransformerWithTapChangerMax TRANSFORMER_LOAD_2_1(SNom = 1e9, UNomA = 400e3, UNomB = 63e3, K = 63/400*{0.96, 0.97, 0.98, 0.99, 1.00}, UMax = 60000, UStop = 59000, Ntap = 5, t1st = 1, tNext = 1, tapStart = 5, X = 0.3, R = 0.003, portVariablesPhases = true);
  PowerGrids.Electrical.Branches.TransformerWithTapChangerMax TRANSFORMER_LOAD_2_2(SNom = 1e9, UNomA = 400e3, UNomB = 63e3, K = 63/400*{0.96, 0.97, 0.98, 0.99, 1.00}, UMax = 60000, UStop = 59000, Ntap = 5, t1st = 1, tNext = 1, tapStart = 5, X = 0.3, R = 0.003, portVariablesPhases = true);
  PowerGrids.Electrical.Branches.TransformerWithTapChangerMax TRANSFORMER_LOAD_3_1(SNom = 1e9, UNomA = 400e3, UNomB = 63e3, K = 63/400*{0.96, 0.97, 0.98, 0.99, 1.00}, UMax = 60000, UStop = 59000, Ntap = 5, t1st = 1, tNext = 1, tapStart = 5, X = 0.3, R = 0.003, portVariablesPhases = true);
  PowerGrids.Electrical.Branches.TransformerWithTapChangerMax TRANSFORMER_LOAD_3_2(SNom = 1e9, UNomA = 400e3, UNomB = 63e3, K = 63/400*{0.96, 0.97, 0.98, 0.99, 1.00}, UMax = 60000, UStop = 59000, Ntap = 5, t1st = 1, tNext = 1, tapStart = 5, X = 0.3, R = 0.003, portVariablesPhases = true);
  PowerGrids.Electrical.Branches.TransformerWithTapChangerMax TRANSFORMER_LOAD_4_1(SNom = 1e9, UNomA = 400e3, UNomB = 63e3, K = 63/400*{0.96, 0.97, 0.98, 0.99, 1.00}, UMax = 60000, UStop = 59000, Ntap = 5, t1st = 1, tNext = 1, tapStart = 5, X = 0.3, R = 0.003, portVariablesPhases = true);
  PowerGrids.Electrical.Branches.TransformerWithTapChangerMax TRANSFORMER_LOAD_4_2(SNom = 1e9, UNomA = 400e3, UNomB = 63e3, K = 63/400*{0.96, 0.97, 0.98, 0.99, 1.00}, UMax = 60000, UStop = 59000, Ntap = 5, t1st = 1, tNext = 1, tapStart = 5, X = 0.3, R = 0.003, portVariablesPhases = true);
